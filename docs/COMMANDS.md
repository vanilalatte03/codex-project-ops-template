...
| docs-check |  | no | phase별 `docs-checks.json` 기반 문서 일관성 검사 |
...
| autopilot | `python scripts/autopilot.py <phase-name> --max-review-fixes 2` | no | step별 PR 생성, 자체 리뷰, 이슈 기록, 자동 병합 루프 |
